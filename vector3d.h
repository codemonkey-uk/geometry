...
namespace Geometry
{
	...
	*/
    ...
    template< typename Scalar >    
    class Line3d : public LineN< Vector3d<Scalar> >
    {
        public:
        ...
        Line3d( const VectorType& start, const VectorType& finish )
            : LineN<Vector3d<Scalar> >(start, finish)
        {
        }
        ...
        Line3d( 
            ...
            : LineN<Vector3d<Scalar> >( VectorType(start), VectorType(finish))
        {
        }
    };
}
